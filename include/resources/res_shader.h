...
public:
    ...
    void bind() {
        ...
        this->operator[]("u_view") = glm::inverse(Camera::get_target_camera()->get_matrix());
        this->operator[]("u_proj") = Camera::get_target_camera()->get_projection_matrix();

        //Camera::get_target_camera()->set_shader_uniforms(*this, entity, registry);
    }
