...
public:
    ...
    {
        if (member_name == "VAO") { return std::to_string(VAO); }
        else if (member_name == "vertex_VBO") { return std::to_string(vertex_VBO); }
        else if (member_name == "face_SSBO") { return std::to_string(face_SSBO); }
        else if (member_name == "solid_EBO") { return std::to_string(solid_EBO); }
        else if (member_name == "size()") { return std::to_string(points.size()); }
        //else if (member_name == "velocity") { return to_string(last_camera_pos); }
    }


    static const char* get_name() { return "ent_brush"; }

    static std::string get_member(void* me, std::string member_name) {
        ent_brush* self = (ent_brush*)me;
        if (member_name == "VAO") { return std::to_string(self->VAO); }
