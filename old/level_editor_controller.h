...
public:
    ...
    {
        if (member_name == "vertical_sensitivity") { return std::to_string(vertical_sensitivity); }
        else if (member_name == "horizontal_sensitivity") { return std::to_string(horizontal_sensitivity); }
        else if (member_name == "move_speed") { return std::to_string(move_speed); }
        else if (member_name == "sprint_multiplier") { return std::to_string(sprint_multiplier); }
        else if (member_name == "clip") { return std::to_string(clip); }
